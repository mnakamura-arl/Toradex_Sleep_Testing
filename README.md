...
Two Toradex stacks: the **DUT** (Verdin + peripherals, `192.168.77.213`) runs
the `scripts/` sleep tests; the **monitor** (`192.168.77.212`) runs this
...
./tools/pm_run.sh init && ./tools/pm_run.sh push torizon@192.168.77.213
./tools/pm_run.sh run torizon@192.168.77.213 suspend-60 \
    'cd sleep_test/scripts && sudo ./02-suspend-cycle.sh -d 60'
./tools/pm_run.sh report
./tools/pm_run.sh collect torizon@192.168.77.213   # -> results-<RUN_ID>.tgz
```
